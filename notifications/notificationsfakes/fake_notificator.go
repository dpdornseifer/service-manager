...
type FakeNotificator struct {
	RegisterConsumerStub        func(*web.UserContext) (notifications.NotificationQueue, int64, error)
	registerConsumerMutex       sync.RWMutex
	registerConsumerArgsForCall []struct {
		arg1 *web.UserContext
	}
	registerConsumerReturns struct {
		result1 notifications.NotificationQueue
		result2 int64
		result3 error
	}
	...
	UnregisterConsumerStub        func(notifications.NotificationQueue) error
	unregisterConsumerMutex       sync.RWMutex
	unregisterConsumerArgsForCall []struct {
		arg1 notifications.NotificationQueue
	}
...
func (fake *FakeNotificator) RegisterConsumer(arg1 *web.UserContext) (notifications.NotificationQueue, int64, error) {
...
func (fake *FakeNotificator) RegisterConsumerCalls(stub func(*web.UserContext) (notifications.NotificationQueue, int64, error)) {
	fake.registerConsumerMutex.Lock()
...
func (fake *FakeNotificator) RegisterConsumerReturns(result1 notifications.NotificationQueue, result2 int64, result3 error) {
	fake.registerConsumerMutex.Lock()
	defer fake.registerConsumerMutex.Unlock()
...
func (fake *FakeNotificator) RegisterConsumerReturnsOnCall(i int, result1 notifications.NotificationQueue, result2 int64, result3 error) {
	fake.registerConsumerMutex.Lock()
	defer fake.registerConsumerMutex.Unlock()
	fake.RegisterConsumerStub = nil
...
func (fake *FakeNotificator) UnregisterConsumer(arg1 notifications.NotificationQueue) error {
...
func (fake *FakeNotificator) UnregisterConsumerCalls(stub func(notifications.NotificationQueue) error) {
	fake.unregisterConsumerMutex.Lock()
	defer fake.unregisterConsumerMutex.Unlock()
	fake.UnregisterConsumerStub = stub
}

func (fake *FakeNotificator) UnregisterConsumerArgsForCall(i int) notifications.NotificationQueue {
	fake.unregisterConsumerMutex.RLock()
	defer fake.unregisterConsumerMutex.RUnlock()
...
var _ notifications.Notificator = new(FakeNotificator)
